(function(Vue, window, document) {
    ...
    var projectdoc = {
        ...
        loadList: function() {
            ...
            //2.后台请求
            if (listInfo) {
                bmplugin.ajax.post('/web/common/projectdoc/loadlist', listInfo).then(function(data) {
         ...
         * 加载待办数据
         */
        loadProjectDocInfo: function(id) {
            return bmplugin.ajax.post('/web/common/projectdoc/loadprojectdocinfo', {id: id}).then(function(data) {
        ...
        methods: {
            ...
            showArticle: function(id) {
                ...
                new Promise(function(resolve) {
                    //1.加载角色信息
                    resolve(projectdoc.loadProjectDocInfo(id));
                }).catch(function(error) {
                    bmplugin.showErrMsg(error);
                });
            }
