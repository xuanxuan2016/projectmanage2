...
use App\Http\Model\Web\Common\HomeModel;
...
class HomeController extends BaseController {
     ...
     * 依赖注入，使用外部类
     */
    public function __construct(HomeModel $objHomeModel) {
        $this->objHomeModel = $objHomeModel;
    }
    ...
    protected function getViewData() {
        return [
             ...
             */
            'js' => [
                ['path' => 'page/common/home.js', 'is_pack' => 1, 'is_remote' => 0]
            ],
            /**
             * css
             */
            'css' => [
                ['path' => 'page/common/home.css', 'is_pack' => 1, 'is_remote' => 0]
            ]
        ];
    }
