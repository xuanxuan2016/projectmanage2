...
class HttpKernel {
    ...
    protected function dispatch() {
        ...
        $arrMiddleware = Config::get('app.middleware.all');
     ...
     * @param Exception $objException
     */
    protected function renderException(Exception $objException) {
        return $this->objApp->make(ExceptionHandlerContract::class)->render($objException);
    }
