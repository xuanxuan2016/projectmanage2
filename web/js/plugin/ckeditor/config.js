...
CKEDITOR.editorConfig = function(config) {
    ...
    config.removeButtons = 'Templates,Save,NewPage,Scayt,Form,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,Checkbox,Subscript,Superscript,Language,Anchor,Image,Flash,Iframe,PageBreak,About';
...
//    //编辑器中回车产生的标签
    config.enterMode = CKEDITOR.ENTER_BR; //可选：CKEDITOR.ENTER_BR或CKEDITOR.ENTER_DIV或CKEDITOR.ENTER_P
