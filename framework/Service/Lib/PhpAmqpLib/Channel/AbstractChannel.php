...
namespace Framework\Service\Lib\PhpAmqpLib\Channel;

use Framework\Service\Lib\PhpAmqpLib\Connection\AbstractConnection;
use Framework\Service\Lib\PhpAmqpLib\Exception\AMQPOutOfBoundsException;
use Framework\Service\Lib\PhpAmqpLib\Exception\AMQPOutOfRangeException;
use Framework\Service\Lib\PhpAmqpLib\Exception\AMQPRuntimeException;
use Framework\Service\Lib\PhpAmqpLib\Helper\DebugHelper;
use Framework\Service\Lib\PhpAmqpLib\Helper\Protocol\MethodMap080;
use Framework\Service\Lib\PhpAmqpLib\Helper\Protocol\MethodMap091;
use Framework\Service\Lib\PhpAmqpLib\Helper\Protocol\Protocol080;
use Framework\Service\Lib\PhpAmqpLib\Helper\Protocol\Protocol091;
use Framework\Service\Lib\PhpAmqpLib\Helper\Protocol\Wait080;
use Framework\Service\Lib\PhpAmqpLib\Helper\Protocol\Wait091;
use Framework\Service\Lib\PhpAmqpLib\Message\AMQPMessage;
use Framework\Service\Lib\PhpAmqpLib\Wire\AMQPReader;
...
abstract class AbstractChannel {
    ...
    /** @var \Framework\Service\Lib\PhpAmqpLib\Helper\DebugHelper */
    protected $debug;

    /** @var \Framework\Service\Lib\PhpAmqpLib\Connection\AbstractConnection */
    ...
    /** @var \Framework\Service\Lib\PhpAmqpLib\Helper\Protocol\Protocol080|\Framework\Service\Lib\PhpAmqpLib\Helper\Protocol\Protocol091 */
    protected $protocolWriter;

    /** @var \Framework\Service\Lib\PhpAmqpLib\Helper\Protocol\Wait080|\Framework\Service\Lib\PhpAmqpLib\Helper\Protocol\Wait091 */
    protected $waitHelper;

    /** @var \Framework\Service\Lib\PhpAmqpLib\Helper\Protocol\MethodMap080|\Framework\Service\Lib\PhpAmqpLib\Helper\Protocol\MethodMap091 */
    protected $methodMap;

    /** @var string */
    protected $channel_id;

    /** @var \Framework\Service\Lib\PhpAmqpLib\Wire\AMQPReader */
     ...
     * @throws \Framework\Service\Lib\PhpAmqpLib\Exception\AMQPRuntimeException
     */
    public function __construct(AbstractConnection $connection, $channel_id) {
        ...
        switch ($this->protocolVersion) {
            case self::PROTOCOL_091:
                self::$PROTOCOL_CONSTANTS_CLASS = 'Framework\Service\Lib\PhpAmqpLib\Wire\Constants091';
            ...
            case self::PROTOCOL_080:
                self::$PROTOCOL_CONSTANTS_CLASS = 'Framework\Service\Lib\PhpAmqpLib\Wire\Constants080';
                $c = self::$PROTOCOL_CONSTANTS_CLASS;
                $this->debug = new DebugHelper($c);
                $this->amqp_protocol_header = $c::$AMQP_PROTOCOL_HEADER;
     ...
     * @param \Framework\Service\Lib\PhpAmqpLib\Wire\AMQPWriter|string $args
     */
     ...
     * @param array $method_sig
     * @param \Framework\Service\Lib\PhpAmqpLib\Wire\AMQPWriter|string $args
     * @param \Framework\Service\Lib\PhpAmqpLib\Wire\AMQPWriter $pkt
     * @return \Framework\Service\Lib\PhpAmqpLib\Wire\AMQPWriter
     */
     ...
     * @return \Framework\Service\Lib\PhpAmqpLib\Message\AMQPMessage
     */
     ...
     * @param int $timeout
     * @throws \Framework\Service\Lib\PhpAmqpLib\Exception\AMQPOutOfBoundsException
     * @throws \Framework\Service\Lib\PhpAmqpLib\Exception\AMQPRuntimeException
     * @return mixed
     */
