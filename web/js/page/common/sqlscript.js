(function(Vue, window, document) {
    ...
    var sqlscript = {
        ...
        loadList: function() {
            ...
            //2.后台请求
            if (listInfo) {
                bmplugin.ajax.post('/web/common/sqlscript/loadlist', listInfo).then(function(data) {
         ...
         * 加载待办数据
         */
        loadSqlScriptInfo: function(id) {
            return bmplugin.ajax.post('/web/common/sqlscript/loadsqlscriptinfo', {id: id}).then(function(data) {
        ...
        methods: {
            ...
            showArticle: function(id) {
                ...
                new Promise(function(resolve) {
                    //1.加载角色信息
                    resolve(sqlscript.loadSqlScriptInfo(id));
                }).catch(function(error) {
                    bmplugin.showErrMsg(error);
                });
            }
